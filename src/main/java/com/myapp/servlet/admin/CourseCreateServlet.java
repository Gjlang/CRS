...
public class CourseCreateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/admin/courses/create.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        boolean ok = courseDAO.create(c);
        if (ok) {
            resp.sendRedirect(req.getContextPath() + "/admin/courses");
        } else {
            req.setAttribute("error", "Failed to create course (duplicate code?).");
            req.getRequestDispatcher("/admin/courses/create.jsp").forward(req, resp);
        }
    }
